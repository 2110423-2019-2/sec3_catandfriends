...
router.get('/', async (req, res) => {
    ...
    // let andCount = 0;
    // //////for price searching//////
    if (price.price0To500 || price.price500To1500 || price.price3500To6500 || price6500AndAbove) {
        query.$and.push({ $or: [] });
        ...
        if (price6500AndAbove) query.$and[0].$or.push({ "price": { $gte: 6500 } });
    }
    ...
    //     }
    // }
    // if (category[0] == "1") query.$and[andCount].$or.push({ "category": "mathematics" });
    // if (category[1] == "1") query.$and[andCount].$or.push({ "category": "science" });
    // if (category[2] == "1") query.$and[andCount].$or.push({ "category": "social" });
    // if (category[3] == "1") query.$and[andCount].$or.push({ "category": "language" });
