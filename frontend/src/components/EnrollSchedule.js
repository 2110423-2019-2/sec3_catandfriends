...
export default class EnrollSchedule extends Component {
    ...
    render() {
        ...
        return (
            ...
            <h4 className="card-title" style={{textAlign:"center"}}>Enrollment and Schedule</h4>
            <br/>
            <div className="row">
...
class RowInformation extends Component {
    ...
    render() {
        const {studentId,courseId,courseName,tutorName,enrollDate,startDate,endDate} = this.props.detail
        return (
            <div className="row" key={this.props.detail.courseId} style={{textAlign:"left"}}>
                <div class="col-md-2 border"  >
